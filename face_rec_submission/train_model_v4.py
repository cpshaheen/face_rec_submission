...
def train(model,data_generator,train_idx,valid_idx,b_size):
    init_lr = 1e-4
    epochs = 100
    ...
    model.save('face_model_v4_'+str(b_size)+'_'+today.strftime("%m-%d-%y")+'.h5')
...
def acc_check(history, b_size):
    ...
    plt.savefig('acc_race_v4'+str(b_size)+'_'+today.strftime("%m-%d-%y")+'.png')
    ...
    plt.savefig('acc_gender_v4'+str(b_size)+'_'+today.strftime("%m-%d-%y")+'.png')
...
def loss_check(history, b_size):
    ...
    plt.savefig('overall_loss_v4'+str(b_size)+'_'+today.strftime("%m-%d-%y")+'.png')
